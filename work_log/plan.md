...
## 사용자 실테스트 대기
- 공고 상세(2026-09-25): 직접 추가한 사이트의 공고를 열면 진행중/마감 배지가 **없고**, 나라장터 등 공공 출처 공고는 배지가 그대로 있다.
- 공고 상세 extra(2026-09-25, bid-collectors v1.2.5 반영 — REQUIREMENTS F-007 셋째 항목): 나라장터 용역·물품·공사 공고를 하나씩 열면
  "나라장터 상세"에 입찰 구분·추정 가격·배정 예산·방식들·개찰 일시·담당자가 보인다(공사는 평가 비율 없음, 용역은 담당자 이메일 없음이 정상).
  K-Startup·기업마당 공고는 "상세 정보"가 태그(`<p>` 등) 없이 보인다.
